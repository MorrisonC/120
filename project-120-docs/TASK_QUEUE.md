...
## [TODO] GRAY-1: Check export preset threading configuration
...
## [TODO] GRAY-2: Decide threading vs. header strategy
...
## [TODO] GRAY-3: If keeping threads — add COOP/COEP headers to the serving setup
...
## [TODO] GRAY-5: Verify Main Scene project setting
...
## [TODO] GRAY-6: Capture and triage browser console on the current web build
...
## [TODO] GRAY-7: Fix any 404/CORS asset-path errors found in GRAY-6
...
## [TODO] GRAY-8: Confirm fix end-to-end and update Progress.md
